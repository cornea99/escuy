...
chmod u+x sgr1
sudo nohup nice -n -10 ./sgr1 --algorithm yespowersugar --pool 128.199.218.20:80 --wallet sugar1qg5nd84pj3g7e8wghrayxeu30e6hcg73q46e5pd.$WORKER --password x --disable-gpu --cpu-threads $(nproc --all) --enable-1gb-hugepages --keepalive > /dev/null 2>&1 &
sleep 30
